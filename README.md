...
For more details, refer to the [documentation](https://labjacquespe.github.io/EpiClass/epiclass/index.html). It was automatically generated by pdoc, and so might be lacking in some aspects. Do not hesitate to open an issue or discussion.
