...
author: "Joanny Raby"
resources:
    - "../resources/threshold_impact_graph_global_assay_epiclass_11c-11_classes_cdn.html"
    - "../resources/threshold_impact_graph_global_harmonized_sample_ontology_intermediate-16_classes_cdn.html"
format:
  html:
    code-fold: true
    code-tools: true
...
![](../resources/fig1A.png){fig-align="center"}
...
def create_confusion_matrix(
    ...
    """Create a confusion matrix for the given DataFrame and display it.
    ...
    files = mat_writer.to_all_formats(logdir, name=f"confusion_matrix_n{len(filtered_df)}")
...
![](../resources/fig1E.png){fig-align="center"}
...
For the code that produced the figures, see `src/python/epiclass/utils/notebooks/paper/confidence_threshold.ipynb` ([permalink](https://github.com/labjacquespe/EpiClass/blob/e87306bccecd3e35d9ffdbb5ddb29fcaa0800a35/src/python/epiclass/utils/notebooks/paper/confidence_threshold.ipynb)).

<iframe src="../resources/threshold_impact_graph_global_assay_epiclass_11c-11_classes_cdn.html"
        scrolling="no"
        style="display: block; margin: 0 auto; width: 100%; max-width: 710px; aspect-ratio: 710 / 615; border: 0; overflow: hidden;">
</iframe>

<iframe src="../resources/threshold_impact_graph_global_harmonized_sample_ontology_intermediate-16_classes_cdn.html"
        scrolling="no"
        style="display: block; margin: 0 auto; width: 100%; max-width: 710px; aspect-ratio: 710 / 615; border: 0; overflow: hidden;">
</iframe>
...
def prepare_metric_sets_per_assay(
    ...
    md5_per_assay = metadata.ids_per_class(ASSAY)
...
![](../resources/Supp3.png){fig-align="center"}
...
![](../resources/Supp4.png){fig-align="center"}
